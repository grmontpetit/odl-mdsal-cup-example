package org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231;
...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup} instances.
 * @see org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup
 */
public class CupBuilder {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> augmentation = new HashMap<>();
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public CupBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup> augmentation) {
    ...
    private static final class CupImpl implements Cup {
        ...
        public java.lang.Class<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup.class;
        }
        ...
        private Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> augmentation = new HashMap<>();
        ...
        private CupImpl(CupBuilder base) {
            ...
            this._cupStatus = base.getCupStatus();
                ...
                case 0:
                    ...
                    break;
                    case 1:
                        final Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> e = base.augmentation.entrySet().iterator().next();
                        this.augmentation = Collections.<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>singletonMap(e.getKey(), e.getValue());       
                    break;
                default :
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup other = (org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                for (Map.Entry<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>>, Augmentation<org.opendaylight.yang.gen.v1.http.netconfcentral.org.ns.tea.time.rev691231.Cup>> e : augmentation.entrySet()) {
