package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.cup.provider.impl.rev140131 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "cup-provider-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:cup-provider:impl";
    private final String revision = "2014-01-31";
    private final String resourcePath = "/META-INF/yang/cup-provider-impl.yang";
